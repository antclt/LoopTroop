...
- For minor changes, avoid full test suites and linting. Only run localized tests and checks.
...
- **Under no circumstances** should you delete, stage, or touch existing uncommitted files (e.g. other work-in-progress files in the working directory). NO EXCEPTIONS!

 ...
 *
 * The periodic flush-to-disk logic was removed because intermediate snapshots
 * caused quadratic content growth (each snapshot carried the full accumulated
 * text, producing ~90 progressive copies for a 5-minute streaming session).
 *

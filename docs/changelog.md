...
### Summary
- Generalised collapsible log sections to be manually resizable up or down across all phases and statuses.
...
#### Changed
- Updated all collapsible phase log sections across ticket workspaces to support manual vertical resizing via a drag handle.

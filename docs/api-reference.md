...
| `POST` | `/api/tickets/:id/manual-qa/submit` | Validate and submit the complete round; rejects merge groups containing any non-Fail member and creates requested improvements/failure beads idempotently |

...
- [Prompt Inventory](prompts.md): built-in prompt templates, collapsed full prompt content, runtime prompt builders, workflow usage, tool policies, and context inputs.

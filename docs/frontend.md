...
- `ErrorOccurrencesPanel` for active and past failures; its compact header shows only count/state, leaving specific bead and error details to the expanded rows and workspace view

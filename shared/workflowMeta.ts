...
const BASE_WORKFLOW_PHASES: WorkflowPhaseMeta[] = [
  ...
  },
  {
    ...
    description: 'The locked main implementer scans the codebase and extracts relevant file paths, excerpts, and rationales. Configured structured scan retries are preserved in Raw attempts while the shared context artifact contains only accepted normalized files.',

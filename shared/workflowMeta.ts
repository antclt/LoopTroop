...
const WORKFLOW_PHASE_DETAILS = {
  ...
  PREPARING_EXECUTION_ENV: {
    ...
    steps: [
      ...
      'Structured Validation: LoopTroop parses the result via a strict marker/schema contract. If the marker or schema is wrong, it may use the ticket\'s configured Structured Output Retries count with a continued session repair prompt instead of treating the attempt as an implementation failure, and records rejected/accepted raw attempts on the setup report.',

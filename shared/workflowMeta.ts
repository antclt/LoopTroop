...
const BASE_WORKFLOW_PHASES: WorkflowPhaseMeta[] = [
  ...
  },
  {
    ...
    description: 'Verifying readiness, provisioning missing required runtime tooling under ticket-owned temp roots, validating declared wrappers/tooling probes before coding begins, and recording provisioning-attempt evidence. Ready setup results are blocked if probes fail, wrappers are unusable, or committable project changes are left behind.',

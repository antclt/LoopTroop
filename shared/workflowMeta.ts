...
const BASE_WORKFLOW_PHASES: WorkflowPhaseMeta[] = [
  ...
  },
  {
    ...
    label: 'Manual QA',
    description: 'LoopTroop is waiting for user-run verification in an autosaved Manual QA checklist: items start Pending, Pass and Waive require no evidence, file changes settle before completion, and Submit or Skip finishes the round.',

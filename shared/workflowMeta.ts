...
const BASE_WORKFLOW_PHASES: WorkflowPhaseMeta[] = [
  ...
  },
  {
    ...
    description: 'Verifying readiness and provisioning missing required runtime tooling under ticket-owned temp roots before coding begins. Ready setup results are blocked if they leave committable project changes; generated local noise is logged with `.gitignore` suggestions. Setup-generation retries are captured in Raw attempts, and internal setup commands are audited as concise completion summaries.',

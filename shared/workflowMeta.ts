...
const BASE_WORKFLOW_PHASES: WorkflowPhaseMeta[] = [
  ...
  },
  {
    id: 'BLOCKED_ERROR',
    label: 'Error (reason)',
    description: 'A phase failure paused the workflow. CODING exposes three separate histories for Ralph failures, user retry guidance, and local finalization failures. Finalization failures stay manual Retry/Cancel blocks; eligible provider interruptions may Continue in the preserved session, while iteration-deadline failures use fresh-session Ralph recovery.',

...
const WORKFLOW_PHASE_DETAILS = {
  ...
  PREPARING_EXECUTION_ENV: {
    ...
    outputs: [
      'Canonical execution setup profile artifact describing reusable temp roots, prepared runtime wrappers, tooling probe commands, discovered command families, and quality-gate policy for later coding beads and final testing.',
...
const BASE_WORKFLOW_PHASES: WorkflowPhaseMeta[] = [
  ...
  },
  {
    ...
    description: 'Verifying readiness, provisioning missing required runtime tooling under ticket-owned temp roots, and validating declared wrappers/tooling probes before coding begins. Ready setup results are blocked if probes fail, wrappers are unusable, or committable project changes are left behind.',
